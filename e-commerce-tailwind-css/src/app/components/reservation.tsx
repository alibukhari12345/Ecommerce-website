...
<h2 className='text-2xl font-bold mb-6 text-white'>Make A Reservation of Coming Iphone New model</h2>
...
<div className='mb-4'>
    <button className='bg-red-600 text-white  py-2 px-6 rounded-md font-extraboldbold hover:bg-red-700'>Order Now  </button>
</div>
